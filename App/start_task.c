...
{	
   ...
   xTaskCreate((TaskFunction_t)calibrate_task,
	...
	xTaskCreate((TaskFunction_t)ToogsControl,
                (const char *)"ToogsControl",
                (uint16_t)512,
                (void *)NULL,
                (UBaseType_t)2,
                (TaskHandle_t *)&ChassisTask_Handler);
				
	xTaskCreate((TaskFunction_t)smallwheelControl,
                (const char *)"smallwheelControl",
                (uint16_t)512,
                (void *)NULL,
                (UBaseType_t)2,
                (TaskHandle_t *)&ChassisTask_Handler);

	xTaskCreate((TaskFunction_t)Electromagnetic_valve_control_task,
                (const char *)"Electromagnetic_valve_control_task",
                (uint16_t)512,
                (void *)NULL,
                (UBaseType_t)2,
                (TaskHandle_t *)&ChassisTask_Handler);
				
	xTaskCreate((TaskFunction_t)Steering_Gear_Control_Task,
                (const char *)"Electromagnetic_valve_control_task",
                (uint16_t)512,
                (void *)NULL,
                (UBaseType_t)2,
